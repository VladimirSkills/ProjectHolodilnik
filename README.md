...
<br><strong>Также на сайте есть Антиробот.</strong> При поточном запуске тестов, возможна блокировка IP-адреса. Лимит на авторизацию - 10 раз.
...
<br>Python 3.8 / IDE: PyCharm 2021.3.3
